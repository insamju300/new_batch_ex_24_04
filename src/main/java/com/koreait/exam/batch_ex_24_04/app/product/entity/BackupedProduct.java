...
public class BackupedProduct extends BaseEntity {
    ...
    private List<BackupedProductOption> productOptions = new ArrayList<>();

    public void addOption(BackupedProductOption option) {
